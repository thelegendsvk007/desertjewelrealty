...
interface CityData {
  ...
  highlights: string[];
  keyAreas: string[];
  averagePrice: string | React.ReactElement;
  rentalYield: string;
  lifestyle: {
    walkability: number;
  ...
  const emiratesData: CityData[] = [
    {
      ...
      averagePrice: (<><DirhamLogo className="inline align-middle mr-1" size="xs" variant="green" /> 1,200 - 2,500 per sqft</>),
      rentalYield: '5-8%',
      lifestyle: {
        walkability: 85,
        familyFriendly: 90,
    ...
    },
    {
      ...
      averagePrice: (<><DirhamLogo className="inline align-middle mr-1" size="xs" variant="green" /> 900 - 2,000 per sqft</>),
      rentalYield: '6-9%',
      lifestyle: {
        walkability: 80,
        familyFriendly: 95,
    ...
    },
    {
      ...
      averagePrice: (<><DirhamLogo className="inline align-middle mr-1" size="xs" variant="green" /> 600 - 1,200 per sqft</>),
      rentalYield: '7-10%',
      lifestyle: {
        walkability: 75,
        familyFriendly: 90,
    ...
    },
    {
      ...
      averagePrice: (<><DirhamLogo className="inline align-middle mr-1" size="xs" variant="green" /> 450 - 900 per sqft</>),
      rentalYield: '8-12%',
      lifestyle: {
        walkability: 70,
        familyFriendly: 85,
    ...
    },
    {
      ...
      averagePrice: (<><DirhamLogo className="inline align-middle mr-1" size="xs" variant="green" /> 500 - 1,000 per sqft</>),
      rentalYield: '7-11%',
      lifestyle: {
        walkability: 65,
        familyFriendly: 80,
    ...
    },
    {
      ...
      averagePrice: (<><DirhamLogo className="inline align-middle mr-1" size="xs" variant="green" /> 400 - 800 per sqft</>),
      rentalYield: '8-12%',
      lifestyle: {
        walkability: 60,
        familyFriendly: 75,
    ...
    },
    {
      ...
      averagePrice: (<><DirhamLogo className="inline align-middle mr-1" size="xs" variant="green" /> 350 - 700 per sqft</>),
      rentalYield: '9-13%',
      lifestyle: {
        walkability: 55,
        familyFriendly: 80,
