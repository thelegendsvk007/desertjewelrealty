                    ...
                    <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionItem value="item-2">
                        ...
                        <AccordionContent>
                          ...
                          <ul className="list-disc ml-5 space-y-2 mt-2">
                            ...
                            <li>Property registration trustee fee: <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />2,000-4,000</span></li>
                            <li>Mortgage registration fee (if applicable): 0.25% of loan amount</li>
                            <li>Valuation fee (if applicable): <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />2,500-3,500</span></li>
                            <li>NOC (No Objection Certificate) from developer: <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />500-5,000</span></li>
                          </ul>
                      ...
                      <AccordionItem value="item-5">
                        ...
                        <AccordionContent>
                          ...
                          <ul className="list-disc ml-5 space-y-2 mt-2">
                            <li>
                              <strong>Service charges:</strong> Typically range from <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />10-85</span> per sq ft annually, depending on the building's amenities and location.
                            </li>
                            <li>
                      ...
                      <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 mb-4">
                          <div className="flex-1">
                            <Label htmlFor="propertyValue" className="inline-flex items-center gap-1">Property Value (<DirhamLogo variant="black" size="xs" />)</Label>
                            <Input
                              id="propertyValue"
                              type="text"
                        ...
                        {isGoldenVisaEligible !== null && (
                          <div className={`p-4 rounded-md mt-4 ${isGoldenVisaEligible ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
                            ...
                            <div className="mt-3 text-sm">
                              {isGoldenVisaEligible ? (
                                <p>Your property investment of <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />{propertyValue}</span> meets the minimum threshold of <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />2 million</span> for Golden Visa eligibility.</p>
                              ) : (
                                <p>Your property investment of <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />{propertyValue}</span> does not meet the minimum threshold of <span className="inline-flex items-center gap-1"><DirhamLogo variant="black" size="xs" />2 million</span> for Golden Visa eligibility.</p>
                              )}
                            </div>
                          </div>
                        )}
