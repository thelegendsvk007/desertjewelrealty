...
import pantheonLogo from '@/assets/developers/pantheon.jpg';
...
export const developersData: Developer[] = [
  ...
  logo: gfsLogo,
  projectCount: 22,
  description: "With over 20 years of experience, GFS Developments has emerged as a leading name in Dubai’s real estate sector, known for delivering luxurious, high-quality developments backed by engineering excellence and meticulous craftsmanship. As pioneers in the industry, GFS offers a superior property ownership experience defined by comfort, innovation, and strategic value.\n\nFrom concept to completion, GFS Developments integrates cutting-edge design, energy-efficient systems, and robust construction standards to meet the evolving needs of clients. Our commitment to customer satisfaction, timely delivery, and long-term value makes us the trusted choice for investors and homeowners alike.",
  keyProjects: [
    "Builder's Choice",
    "Solid Foundations",
    "Quality Heights",
  ...
  uniqueSellingPoints: [
    "Over 20 years of experience in Dubai’s real estate industry",
    "100% client satisfaction and dedicated real estate team",
    "Timely delivery with focus on transparency and reliability",
    "Luxury developments in strategic, high-growth locations",
    "Sustainable designs with energy efficiency and lasting value"
  ],
  marketPosition: "GFS Developments is recognized as a pioneering real estate brand in Dubai, delivering timeless value through exceptional craftsmanship, innovation, and a strong commitment to sustainable and client-centric practices.",
  established: 2024, // Adjusted based on 20+ years experience
  featured: false
},
...
{
  id: 27,
  name: "Pantheon Developments",
  logo: pantheonLogo,
  projectCount: 10,
  description: "With over 7 years in the UAE real estate market, Pantheon Developments was founded by Kalpesh Kinariwala with a powerful vision to bridge the gap in Dubai's property market by offering high-quality, functional, and luxurious homes without extended wait times or exorbitant prices. Pantheon focuses on creating not just buildings but vibrant, thriving communities where families can grow and life can flourish. Their projects, primarily located in Jumeirah Village Circle and expanding beyond, consistently deliver affordable luxury with a commitment to timely delivery, exceptional customer service, and sustainable development practices. The company prides itself on innovation, trust, and a mission to make dream homes accessible to a wider audience while enhancing the lifestyle and community spirit of its residents.",
  keyProjects: [
    "VOXA by Pantheon (Jumeirah Village Triangle)",
    "One Central (Ras Al Khaimah)",
    "Pantheon 2.0 (Jumeirah Village Triangle)",
    "Maison Elysee Phase 3 (Jumeirah Village Circle)",
    "Maison Elysee (Jumeirah Village Circle)",
    "Elysee Heights (Jumeirah Village Circle)",
    "Pantheon Elysee Phase 3 (Jumeirah Village Circle)"
  ],
  uniqueSellingPoints: [
    "Strong market insight into Dubai’s affordable luxury segment",
    "Uncompromising quality and attention to detail",
    "Building vibrant, family-friendly communities",
    "Commitment to on-time project delivery",
    "Focus on sustainability and responsible development"
  ],
  marketPosition: "Emerging as a trusted mid-market developer, Pantheon is known for affordable luxury projects with strategic locations and quality execution.",
  established: 2016,
  featured: false
}
