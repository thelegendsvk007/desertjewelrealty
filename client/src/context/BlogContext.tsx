...
const sampleBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>The Golden Visa program has been expanded to include more categories of property investors, with the minimum investment threshold adjusted to account for market evolution. Investors purchasing properties worth 2 million AED or more now qualify for 10-year residency visas with simplified renewal processes.</p>
