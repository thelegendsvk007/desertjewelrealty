...
const CurrencyConverter = () => {
  ...
  // Render currency symbol with dirham logo for AED
  const renderCurrencySymbol = (currencyCode: string) => {
    return currencyCode === "AED" ? <DirhamLogo className="inline-block align-middle" size="xs" /> : <span className="inline-block align-middle">{getCurrency(currencyCode).symbol}</span>;
  };
            ...
            <div className="mt-4 p-4 bg-muted rounded-md">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-lg font-medium flex items-center gap-1">
                    <span className="inline-flex items-center gap-0.5">
                      {formatNumber(parseFloat(amount.replace(/,/g, '')))} {renderCurrencySymbol(fromCurrency)}
                    </span>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-lg font-medium flex items-center gap-1">
                    <span className="inline-flex items-center gap-0.5">
                      {formatNumber(convertedAmount)} {renderCurrencySymbol(toCurrency)}
                    </span>
                  </p>
                </div>
              </div>
