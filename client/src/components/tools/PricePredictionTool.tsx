            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="flex items-center gap-0.5">Current Value (<DirhamLogo size="xs" />)</FormLabel>
                      <FormControl>
                        <Input 
              ...
              <div className="p-4 rounded-lg border bg-gray-50">
                ...
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-primary flex items-center gap-2">{predictions[0].value.toLocaleString(undefined, { maximumFractionDigits: 0 })} <DirhamLogo size="sm" /></p>
                  </div>
              ...
              <div className="p-4 rounded-lg border bg-gray-50">
                ...
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-primary flex items-center gap-2">{predictions[1].value.toLocaleString(undefined, { maximumFractionDigits: 0 })} <DirhamLogo size="sm" /></p>
                  </div>
                  <div className="text-right">
                    <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
              ...
              <div className="p-4 rounded-lg border bg-gray-50">
                ...
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-primary flex items-center gap-2">{predictions[2].value.toLocaleString(undefined, { maximumFractionDigits: 0 })} <DirhamLogo size="sm" /></p>
                  </div>
                  <div className="text-right">
                    <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
