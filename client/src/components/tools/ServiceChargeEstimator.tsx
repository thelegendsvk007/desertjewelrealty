                ...
                <SelectContent>
                  {areas.map((area) => (
                    <SelectItem key={area.id} value={area.id}>
                      <span className="flex items-center gap-0.5">{area.name} (Avg. {area.avgRate} <DirhamLogo size="xs" />/sq.ft)</span>
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
                ...
                <SelectContent>
                  {getBuildings().map((building) => (
                    <SelectItem key={building.id} value={building.id}>
                      <span className="flex items-center gap-0.5">{building.name} ({building.rate} <DirhamLogo size="xs" />/sq.ft)</span>
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
            ...
            <div className="mt-6 p-6 border rounded-lg bg-muted/50">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  <span className="flex items-center justify-center gap-1">Based on {currentRate} <DirhamLogo size="xs" /> per square foot</span>
                </p>
              </div>
