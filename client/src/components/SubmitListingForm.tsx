...
• Price: ${formData.price ? Number(formData.price).toLocaleString() : 'Not specified'} AED
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-1 flex items-center gap-1">Price (<DirhamLogo size="xs" />) *</label>
                <Input
                  type="number"
