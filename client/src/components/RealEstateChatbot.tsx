...
const responsePatterns = [
  ...
  },
  {
    ...
    responses: [
      "The UAE Golden Visa requires a minimum property investment of 2 million AED. Would you like me to explain the full benefits and requirements?",
      "Properties worth 2 million AED or more qualify for the Golden Visa program. We have many eligible properties in our listings."
    ]
  },
  {
    keywords: ["palm jumeirah", "palm"],
    responses: [
      "Palm Jumeirah is one of Dubai's most prestigious addresses. Properties there range from 2 million to over 100 million AED. What's your budget range?",
  ...
  },
  {
    ...
    responses: [
      ...
      "Downtown Dubai offers luxury urban living. Prices typically start from 1.5 million AED for apartments. What's your budget range?"
    ]
  },
  {
  ...
  },
  {
    ...
    responses: [
      "You can contact Desert Jewel Realty at: Phone: +971 58 953 2210, Email: info@desertjewelrealty.com, Address:  Dubai, UAE",
      "Here are our contact details: Phone: +971 58 953 2210, Email: info@desertjewelrealty.com. We're located at  Dubai, UAE."
    ]
  },
  {
    keywords: ["price", "cost", "expensive"],
    responses: [
      "Property prices in Dubai vary widely by location. Premium areas like Palm Jumeirah and Downtown start from 1.5-2 million AED for apartments, while more affordable areas like JVC start from 500,000 AED.",
      "The price per square foot ranges from 800 AED in affordable areas to 3,000+ AED in luxury developments. What's your budget and preferred location?"
    ]
  },
  {
