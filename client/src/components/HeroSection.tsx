    ...
    <section className="relative h-[90vh] overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center">
        ...
        >
          ...
          {/* Search Bar */}
          <motion.div 
            className="bg-white/95 backdrop-blur-sm p-4 md:p-6 rounded-2xl shadow-2xl mb-8 border border-white/20 relative"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <form onSubmit={handleSearch}>
              ...
              <div className="hidden md:block">
                ...
                {/* Property Status Filter Buttons - Desktop */}
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                  <div className="flex flex-wrap gap-3">
                    <button
                      type="button"
                      className={`px-4 py-2 sm:px-6 sm:py-3 rounded-xl transition-all duration-300 text-sm font-semibold shadow-sm ${
                        searchParams.status === 'Ready to Move' 
                          ? 'bg-primary text-white shadow-lg transform scale-105' 
